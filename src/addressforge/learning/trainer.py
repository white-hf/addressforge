...
def _derive_decision_policy(workspace_name: str) -> dict[str, float]:
    defaults = {
        ...
        "single_unit_moderate_accept_threshold": 0.74,
        "multi_unit_missing_unit_enrich_threshold": 0.68,
        "single_unit_soft_disagreement_accept_threshold": 0.74,
        "multi_unit_soft_disagreement_enrich_threshold": 0.68,
