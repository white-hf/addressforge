# AddressForge Documentation Hub

AddressForge is an open-source, self-hosted address intelligence platform. It ships with a default Canada / North America model and can be adapted to users' own private address data, custom models, and self-hosted API deployments.
...
- [Requirements](./addressforge-requirements.md)
- [Design](./addressforge-design.md)
- [Roadmap](./addressforge-roadmap.md)
- [Task Breakdown](./addressforge-task-breakdown.md)
- [Version Plan](./addressforge-version-plan.md)

## Operations and control

- [Incremental Ingestion & Continuous Control](./address-library-v3-incremental-control.md)
